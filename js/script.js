document.addEventListener("DOMContentLoaded", function () {
  ...
  const translations = {
    fr: {
      ...
      gtcPriceTitle: "Prix",
      gtcPriceText: "Les prix sont indiqués en euros (€), toutes taxes comprises (TTC), hors frais de livraison. Le Vendeur se réserve le droit de modifier ses prix à tout moment, mais le produit sera facturé au tarif en vigueur au moment de la commande.",
    ...
    en: {
      ...
      gtcPriceTitle: "Price",
      gtcPriceText: "Prices are indicated in euros (€), all taxes included (TTC), excluding delivery costs. The Seller reserves the right to modify its prices at any time, but the product will be invoiced at the rate in effect at the time of the order.",
      gtcOrderTitle: "Order",
      gtcOrderText: "Toute commande implique l'acceptation pleine et entière des présentes CGV. La validation de la commande vaut signature et acceptation des opérations effectuées.",
      gtcPaymentTitle: "Payment",
      gtcPaymentText: "Any order implies full acceptance of these General Terms and Conditions. Validation of the order constitutes signature and acceptance of the operations carried out.",
